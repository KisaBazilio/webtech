...
Сущесвует несколько видов селекторов:
...
### Локальный
При помощи специального атрибута, правила помещаются прямо в HTML тег (селектор не используюстя,
...
**Использовать эти два способа крайне не желательно!!! (но знать про них нужно)**
